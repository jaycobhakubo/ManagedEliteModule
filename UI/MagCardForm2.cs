...
namespace GTI.Modules.Shared
{
    ...
    /// </summary>
    public partial class MagCardForm2 : EliteGradientForm
    {
        ...
        public MagCardForm2(MagneticCardReader magCardReader)
            : base(new NormalDisplayMode())
        {
            // PDTS 1064
        ...
        /// null reference.</exception>
        public MagCardForm2(DisplayMode displayMode)
            : base(displayMode)
        {
        ...
        /// <exception cref="System.ArgumentNullException">magCardReader is a 
        /// null reference.</exception>
        public MagCardForm2(DisplayMode displayMode, MagneticCardReader magCardReader)
            : base(displayMode)
        {
            // PDTS 1064
            if(magCardReader == null)
